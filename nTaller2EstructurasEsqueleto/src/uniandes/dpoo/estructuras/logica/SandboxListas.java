...
public class SandboxListas
{
    ...
    {
    	listaEnteros.removeIf(entero -> entero == valor);
    }
    ...
    {
    	listaCadenas.removeIf(str -> str == cadena);
    }
    ...
    public void generarEnteros( int cantidad, int minimo, int maximo )
    {
    	...
    	for (int i = 0; i < cantidad; i++) {
    		int valorNuevo = (int)(Math.random() * (maximo - minimo + 1)) + minimo;
    		listaEnteros.add(valorNuevo);
    	}
    }
