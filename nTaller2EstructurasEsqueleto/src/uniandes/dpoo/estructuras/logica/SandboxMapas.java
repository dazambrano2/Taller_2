...
public class SandboxMapas
{
    ...
    {
        Set<String> llavesMayus = new HashSet<>();
    ...
    {
    	String nuevaLlave = new StringBuilder(cadena).reverse().toString(); 
    	mapaCadenas.put(nuevaLlave, cadena);
    }
    ...
    public void reiniciarMapaCadenas( List<Object> objetos )
    {
    	...
    	for (Object obj : objetos) {
    		...
    		String newKey = new StringBuilder(cadena).reverse().toString();
    		mapaCadenas.put(newKey, cadena);
    	}
    }
    ...
    public void volverMayusculas( )
    {
    	...
    	for (Map.Entry<String, String> entry : mapaCadenas.entrySet()) {
    		...
    		newMap.put(llaveMayus, entry.getValue());
    	}
    	mapaCadenas = newMap;
    }
